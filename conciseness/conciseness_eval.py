"""
Evaluate conciseness performance of a single fine-tuned language model.

This script evaluates a model fine-tuned for conciseness by:
...
- Generating multiple samples per prompt for statistical robustness
...
Results are saved as JSON/JSONL with detailed evaluation statistics including
generation parameters, reward distributions, and KL divergence analysis.
"""
