#!/bin/bash
#SBATCH --job-name=classify_reward_cost
#SBATCH --output=logs/classify_reward_cost_%A_%a.log
#SBATCH --error=logs/classify_reward_cost_%A_%a.err
...
# 
# Usage:
#   sbatch alignment/evaluation/run_classify_reward_cost.sh                    # Run all sweeps
#   sbatch --array=0-2 alignment/evaluation/run_classify_reward_cost.sh        # Run first 3 sweeps
#   sbatch --array=0 alignment/evaluation/run_classify_reward_cost.sh          # Run only first sweep
#   sbatch --array=1,3,4 alignment/evaluation/run_classify_reward_cost.sh      # Run specific sweeps
#
# To specify a different config file:
#   CONFIG_FILE=my_sweeps.yaml sbatch alignment/evaluation/run_classify_reward_cost.sh
# ============================================================
